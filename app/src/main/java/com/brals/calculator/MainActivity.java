...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnAC, btnDel, btnDiv, btnMulti, btn0, btn1, btn2, btn3, btn4, btn5,
    btn6, btn7, btn8, btn9, btnMinus, btnPlus, btnEqual, btnDot;
